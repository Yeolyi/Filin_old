...
extension Color {
    public func lighter(by amount: CGFloat = 0.2) -> Self { Color(self.uiColor().lighter(by: amount)) }
    public func darker(by amount: CGFloat = 0.2) -> Self { Color(self.uiColor().darker(by: amount)) }
}
extension Color {
